...
public interface PetriNetwork {
	 ...
	 * @param type       Type of edge (including if it is an In (towards place) or
	 *                   Out (towards transition) edge)
	 */
	public void add(Place place, Transition transition, int weight, EdgeType type);

	/**
	 * Remove a place from the network. Will also remove all edges linked to this
	 * place
	 * 
